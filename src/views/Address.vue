...
<div>
	...
	<bread><span>MyAddress</span></bread>
  ...
  <div class="container">
          ...
          <ul>
            ...
            <li v-for="(item,index) in AddressListFilter" :class="{'check':checkIndex == index}" @click="checkIndex=index;selectedAddressId=item.addressId">
              ...
              <div class="addr-opration addr-del">
                <a href="javascript:;" class="addr-del-btn" @click="confirmModal(item.addressId)">
	...
	<modal :mdshow="isModal" @close="closeModal">
		<p slot="message">你确定要删除此地址吗？</p>
		<div slot="btnGroup">
			<a href="javascript:;" class="btn btn--m" @click="delAddress">确认</a>
			<a href="javascript:;" class="btn btn--m" @click="isModal=false">取消</a>
		</div>
