    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <div class="navbar-cart-container">
          ...
          <a class="navbar-link navbar-cart-link" href="javascript:;" @click="checkLogin">
					...
					<div class="confirm-tips">
						...
						<ul>
							<li class="regi_form_input">
								...
								<input type="text" tabindex="1" name="loginname" class="regi_login_input" placeholder="User Name" v-model="userName" />
							</li>
							<li class="regi_form_input noMargin">
								<i class="icon IconPwd"></i>
								<input type="password" tabindex="2" name="password" class="regi_login_input" placeholder="Password" v-model="userPwd" @keyup.enter="login"/>
							</li>
						</ul>
					</div>
